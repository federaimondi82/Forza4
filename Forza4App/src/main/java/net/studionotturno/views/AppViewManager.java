...
public class AppViewManager {
    ...
    public static final AppView SPLASH = view("Splash", SplashPresenter.class, MaterialDesignIcon.HOME, HOME_VIEW);
    public static final AppView GAME_VIEW = view("Play Match", GamePresenter.class, MaterialDesignIcon.DASHBOARD,SHOW_IN_DRAWER);
